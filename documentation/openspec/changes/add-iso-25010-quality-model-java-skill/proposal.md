...
- Cover all nine ISO/IEC 25010:2023 quality characteristics: Functional Suitability, Performance Efficiency, Compatibility, Interaction Capability, Reliability, Security, Maintainability, Flexibility, Safety. Issue #1127 named eight of these and omitted Interaction Capability; that characteristic is added here to match the published ISO/IEC 25010:2023 product quality model (see Source and Derivation) and the `032-architecture-adr-non-functional-requirements` questionnaire, which already lists it correctly.
...
- Corrected against the published standard: issue #1127 and its Gherkin acceptance-criteria comment name eight ISO/IEC 25010:2023 quality characteristics and omit Interaction Capability. The published ISO/IEC 25010:2023 product quality model (`https://www.iso.org/standard/78176.html`; confirmed via the IEC catalogue entry, `iso25000.com`, and independent secondary summaries) defines nine characteristics — Functional Suitability, Performance Efficiency, Compatibility, Interaction Capability, Reliability, Security, Maintainability, Flexibility, Safety — where Interaction Capability replaced and expanded "Usability" from the 2011 edition. This repository's own `032-architecture-adr-non-functional-requirements` questionnaire (`plinth-skills-generator/src/main/resources/skill-references/assets/questions/adr-nfr-questions-template.md`) already lists all nine correctly. Treated as an issue oversight, not a deliberate scope decision, and corrected here at maintainer direction so the new skill matches the real standard.
- Unresolved questions or conflicts: none beyond the nine-characteristic correction above, which the maintainer has confirmed.
